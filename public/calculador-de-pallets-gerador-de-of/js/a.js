...
onload = function() {
    ...
    btnCriar.click(function() {
        incrementaID();
        var ccc = iddd;
        divPai.append("<div  id=" + iddd + " onclick='trocaAbaAtual(" + ccc + ")' style='float:left; visibility: hidden; width:80; height:80; background-color:aquamarine; border-radius: 20px; '> <div class='textoBox' style='visibility:visible;width:99px'>ítem A </div> <br > <div class='excluirBox' style='visibility:table-cell;width:20px;vertical-align:middle;'>excluir</div></div>");
        AbaAtual = AbaAtual + 1;
        zeraBotoes();
        document.getElementById("criarLinha").style.visibility = 'hidden';
...
function zeraBotoes() {
    ...
    document.getElementById("Cproduto").style.visibility = 'visible';
    document.getElementById("produto").selectedIndex = 0;
    document.getElementById("CprodutoMangaMaterial").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaTratamento").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaGramatura").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaQuantidade").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaComprimento").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaDiametro").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaColarinho").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaTampao").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaReforco").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaCordoalha").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaRabicho").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaRabichoTamanho").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaRabichoOlhal").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaAlca").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaVolume").style.visibility = 'hidden';
    document.getElementById("CprodutoMangaGuardar").style.visibility = 'hidden';
    document.getElementById("tabelaVolumeFinal").style.visibility = 'hidden';
}
...
function Guardar() {
    switch (AbaAtual) {
        ...
        default:
            ...
            zeraBotoes();
            document.getElementById("Cproduto").style.visibility = 'hidden';
            document.getElementById("Cproduto").value = 0;
            document.getElementById("criarLinha").style.visibility = 'visible';
            document.getElementById("Linha").style.visibility = 'table';
            document.getElementById(iddd).style.visibility = 'visible';
            document.getElementById("btFinaliza").style.visibility = 'visible';
            break;
    }
}
...
function zeraBotoesParcial(botaoz) {
    ...
    //document.getElementById(botaoz).style.display = 'visible';
}
...
function selecionaProduto() {
    ...
    switch (parseInt(value)) {
        case 0:
            ...
            //document.getElementById('CprodutoMangaMaterial').style.visibility = 'visible';
            break;
        case 1:
            Mudarestado('CprodutoMangaMaterial');
            document.getElementById('CprodutoMangaMaterial').style.visibility = 'visible';
...
function selecionaMangaMaterial() {
    ...
    switch (parseInt(value)) {
        case 0:
            ...
            Mudarestado('CprodutoMangaTratamento');
            //document.getElementById('CprodutoMangaTratamento').style.visibility = 'visible';
            break;
        case 1:
            Mudarestado('CprodutoMangaTratamento');
            document.getElementById('CprodutoMangaTratamento').style.visibility = 'visible';
...
function selecionaMangaTratamento() {
    ...
    switch (parseInt(value)) {
        case 0:
            alert("Obrigatório Escolher um Material");
            Mudarestado('CprodutoMangaGramatura');
            //document.getElementById('CprodutoMangaGramatura').style.visibility = 'visible';
            break;
        case 1:
            Mudarestado('CprodutoMangaGramatura');
            document.getElementById('CprodutoMangaGramatura').style.visibility = 'visible';
...
function selecionaMangaGramatura() {
    ...
    switch (parseInt(value)) {
        case 0:
            alert("Obrigatório Escolher um Material");
            Mudarestado('CprodutoMangaQuantidade');
            //document.getElementById('CprodutoMangaQuantidade').style.visibility = 'visible';
            break;
        case 1:
            Mudarestado('CprodutoMangaQuantidade');
            document.getElementById('CprodutoMangaQuantidade').style.visibility = 'visible';
...
function selecionaMangaQuantidade() {
    ...
    switch (parseInt(value)) {
        case 0:
            ...
            Mudarestado('CprodutoMangaComprimento');
            //document.getElementById('CprodutoMangaComprimento').style.visibility = 'visible';
            break;
        default:
            Mudarestado('CprodutoMangaComprimento');
            document.getElementById('CprodutoMangaComprimento').style.visibility = 'visible';
...
function selecionaMangaComprimento() {
    ...
    switch (parseInt(value)) {
        case 0:
            ...
            Mudarestado('CprodutoMangaDiametro');
            //document.getElementById('CprodutoMangaDiametro').style.visibility = 'visible';
            break;
        default:
            Mudarestado('CprodutoMangaDiametro');
            document.getElementById('CprodutoMangaDiametro').style.visibility = 'visible';
...
function selecionaMangaDiametro() {
    ...
    switch (parseInt(value)) {
        ...
        default:
            Mudarestado('CprodutoMangaColarinho');
            document.getElementById('CprodutoMangaColarinho').style.visibility = 'visible';
...
function selecionaMangaColarinho() {
    ...
    switch (parseInt(value)) {
        ...
        case 1:
            Mudarestado('CprodutoMangaTampao');
            document.getElementById('CprodutoMangaTampao').style.visibility = 'visible';
...
function selecionaMangaTampao() {
    ...
    switch (parseInt(value)) {
        ...
        case 1:
            Mudarestado('CprodutoMangaReforco');
            document.getElementById('CprodutoMangaReforco').style.visibility = 'visible';
...
function selecionaMangaReforco() {
    ...
    switch (parseInt(value)) {
        ...
        case 1:
            Mudarestado('CprodutoMangaCordoalha');
            document.getElementById('CprodutoMangaCordoalha').style.visibility = 'visible';
...
function selecionaMangaCordoalha() {
    ...
    switch (parseInt(value)) {
        ...
        case 1:
            Mudarestado('CprodutoMangaRabicho');
            document.getElementById('CprodutoMangaRabicho').style.visibility = 'visible';
...
function selecionaMangaRabicho() {
    ...
    switch (parseInt(value)) {
        ...
        case 1:
            Mudarestado('CprodutoMangaRabichoTamanho');
            document.getElementById('CprodutoMangaRabichoTamanho').style.visibility = 'visible';
...
function selecionaMangaRabichoTamanho() {
    ...
    switch (parseInt(value)) {
        ...
        default:
            Mudarestado('CprodutoMangaRabichoOlhal');
            document.getElementById('CprodutoMangaRabichoOlhal').style.visibility = 'visible';
...
function selecionaMangaRabichoOlhal() {
    ...
    switch (parseInt(value)) {
        ...
        case 1:
            Mudarestado('CprodutoMangaAlca');
            document.getElementById('CprodutoMangaAlca').style.visibility = 'visible';
...
function selecionaMangaAlca() {
    ...
    switch (parseInt(value)) {
        ...
        case 1:
            Mudarestado('CprodutoMangaVolume');
            document.getElementById('CprodutoMangaVolume').style.visibility = 'visible';
...
function selecionaMangaVolume() {
    ...
    switch (parseInt(value)) {
        ...
        case 1:
            Mudarestado('CprodutoMangaGuardar');
            document.getElementById('CprodutoMangaGuardar').style.visibility = 'visible';
            ...
            document.getElementById('tabelaVolumeFinal').style.visibility = 'visible';
